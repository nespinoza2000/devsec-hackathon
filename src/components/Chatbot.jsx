    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div className="flex gap-3 my-4 text-gray-600 text-sm">
            ...
            <p className="leading-relaxed">
              ...
              Hola, ¿qué lugares turísticos de Encarnación te gustaría visitar?
            </p>
          </div>
          ...
          <div className="flex gap-3 my-4 text-gray-600 text-sm">
            ...
            <p className="leading-relaxed">
              ...
              Recomiéndame lugares bailables.
            </p>
          </div>
        ...
        <div className="w-full flex items-center border-t py-2 bg-white border-t-[#e5e7eb]">
          ...
          />
          <button className="bg-black text-white px-4 py-2 rounded-full ml-2">Send</button>
        </div>
      </div>
    </div>
  );
